const DocMenuConfig = [
    ...
    pages: [
      {
        ...
        fontIcon: "bi bi-app-indicator"
      },
      {
        heading: "dashboardDefault",
  ...
  },
  {
    ...
    pages: [
      ...
      {
        heading: "ricondizionamento",
        route: "/menu/ricondizionamento",
